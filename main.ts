                                        ...
                                        case 'Enter the lodge':
                                            ...
                                            switch(leftq4.lq4){
                                                case 'Option1':
                                                    ...
                                                    break;
                                                case 'Option2':
                                                    console.log('You chose to be selfish and ended up becoming a slave to the witch who now possesse the ultimate power to rule all of ',town,
                                                    ' CONGRATULATIONS!!!!!!!!! YOU GOT THE ENDING 2: THE SELFISH ENDING \n XXxGAME OVERxXX')
                                                    loop=false
                                                    break;
                                                }
                                        break;
